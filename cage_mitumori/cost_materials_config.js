...
export const materialsConfig = {
  ...
  // =================================================================
  // 2-2. ゴムパッキン類 (単位: 1mあたり)
  // ※元規格: 定尺6m (NSCP1H-S-6: 841円/6m)
  // =================================================================
  packings: {
    'NSCP1H-S-6': {
      name: 'モレ対策ゴムパッキン (グレー)',
      unit: 'm',
      weightPerMeter: 0.035,   // 重量 (kg/m)
      pricePerMeter: 841 / 6,  // 税込単価 (841円 / 6m ≒ 140.17円/m)
      note: '側面・背面 隙間モレ抑制用'
    }
  },
  ...
  // =================================================================
  pricing: {
    markupRate: 1.4,          // 資材原価に対する販売価格の乗数（基本販売価格 = 原価 × markupRate）
    roundingUnit: 100,        // 端数切り上げ単位（円）: 100円単位で切り上げ
    note: '基本販売価格 = Math.ceil((baseMaterialsCost * markupRate) / roundingUnit) * roundingUnit'
  },

  // =================================================================
  // 7. システム・外部連携設定 (ログ収集・問い合わせ先)
  // =================================================================
  system: {
